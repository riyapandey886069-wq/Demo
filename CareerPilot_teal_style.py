...
"""
    ...
    try:
        ...
        return (
            "The real AI service could not be reached. "
            "Showing local CareerPilot advice instead.\n\n"
...
tab_dashboard, tab_profile, tab_gap, tab_career, tab_roadmap, tab_ai, tab_quiz, tab_system = tabs
